...
describe("First Test Suite", () => {
  ...
  it("Radio button", () => {
    ...
    //using force flag when input is visually hidden
  ...
  it("date picker", () => {
    // recursive function to navigate to future dates in date picker
    ...
    cy.contains("nb-card", "Common Datepicker")
      ...
      .then((input) => {
        ...
        const dateToAssert = selectDayFromCurrent(7);
  ...
  it("lists and drop downs ", () => {
    ...
    //2 iterate a list using a each loop
